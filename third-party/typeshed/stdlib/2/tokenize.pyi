...
def printtoken(
    type: int, token: str, srow_scol: _Pos, erow_ecol: _Pos, line: str
) -> None: ...
def tokenize(
    readline: Callable[[], str],
    tokeneater: Callable[[Tuple[int, str, _Pos, _Pos, str]], None],
) -> None: ...
def tokenize_loop(
    readline: Callable[[], str],
    tokeneater: Callable[[Tuple[int, str, _Pos, _Pos, str]], None],
...
class Untokenizer:
    ...
    def compat(
        self, token: Tuple[int, Any], iterable: Iterator[_TokenType]
    ) -> None: ...
