...
def copyfileobj(
    fsrc: _Reader[AnyStr], fdst: _Writer[AnyStr], length: int = ...
) -> None: ...

if sys.version_info >= (3,):
    def copyfile(
        src: _Path, dst: _AnyPath, *, follow_symlinks: bool = ...
    ) -> _AnyPath: ...
    def copymode(src: _Path, dst: _Path, *, follow_symlinks: bool = ...) -> None: ...
    def copystat(src: _Path, dst: _Path, *, follow_symlinks: bool = ...) -> None: ...
    def copy(src: _Path, dst: _Path, *, follow_symlinks: bool = ...) -> _PathReturn: ...
    def copy2(
        src: _Path, dst: _Path, *, follow_symlinks: bool = ...
    ) -> _PathReturn: ...
...
if sys.version_info >= (3, 9):
    def move(src: _Path, dst: _Path, copy_function: _CopyFn = ...) -> _PathReturn: ...

elif sys.version_info >= (3, 5):
    # See https://bugs.python.org/issue32689
    def move(src: str, dst: _Path, copy_function: _CopyFn = ...) -> _PathReturn: ...
...
if sys.version_info >= (3,):
    ...
    def chown(
        path: _Path, user: Optional[str] = ..., group: Optional[str] = ...
    ) -> None: ...

if sys.version_info >= (3, 8):
    @overload
    def which(
        cmd: _Path, mode: int = ..., path: Optional[_Path] = ...
    ) -> Optional[str]: ...
    @overload
    def which(
        cmd: bytes, mode: int = ..., path: Optional[_Path] = ...
    ) -> Optional[bytes]: ...
