...
class ZipFile:
    ...
    def extract(
        self, member: _SZI, path: Optional[_SZI] = ..., pwd: bytes = ...
    ) -> str: ...
    def extractall(
        self,
        path: Optional[_Path] = ...,
...
class ZipInfo:
    ...
    if sys.version_info >= (3, 8):
        ...
        @classmethod
        def from_file(
            cls, filename: _Path, arcname: Optional[_Path] = ...
        ) -> ZipInfo: ...
    if sys.version_info >= (3, 6):
...
if sys.version_info >= (3, 8):
    class Path:
        ...
        def __init__(
            self, root: Union[ZipFile, _Path, IO[bytes]], at: str = ...
        ) -> None: ...
        def open(
            self,
            mode: str = ...,
