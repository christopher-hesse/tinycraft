...
def setlocale(
    category: int, locale: Union[_str, Iterable[_str], None] = ...
) -> _str: ...
...
def format(
    format: _str, val: Union[float, Decimal], grouping: bool = ..., monetary: bool = ...
) -> _str: ...

if sys.version_info >= (3, 7):
    def format_string(
        format: _str, val: Any, grouping: bool = ..., monetary: bool = ...
    ) -> _str: ...

else:
    def format_string(format: _str, val: Any, grouping: bool = ...) -> _str: ...
