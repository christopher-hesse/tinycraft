...
class memoryview(Sized, Container[_mv_container_type]):
    ...
    if sys.version_info >= (3,):
        ...
        def __init__(
            self, obj: Union[bytes, bytearray, buffer, memoryview]
        ) -> None: ...
    @overload
...
class dict(MutableMapping[_KT, _VT], Generic[_KT, _VT]):
    ...
    ) -> Dict[_T, Any]: ...  # TODO: Actually a class method (mypy/issues#328)
    @staticmethod
    @overload
...
if sys.version_info >= (3,):
    ...
    @overload
    def filter(
        __function: Callable[[AnyStr], Any], __iterable: AnyStr
    ) -> AnyStr: ...  # type: ignore
    @overload
    def filter(
        __function: None, __iterable: Tuple[Optional[_T], ...]
    ) -> Tuple[_T, ...]: ...  # type: ignore
    @overload
    def filter(
        __function: Callable[[_T], Any], __iterable: Tuple[_T, ...]
    ) -> Tuple[_T, ...]: ...  # type: ignore
    @overload
...
if sys.version_info >= (3,):
    ...
    @overload
    def max(
        __iterable: Iterable[_T], *, key: Callable[[_T], Any] = ..., default: _VT
    ) -> Union[_T, _VT]: ...
...
if sys.version_info >= (3, 6):
    def open(
        file: Union[str, bytes, int, _PathLike[Any]],
        mode: str = ...,
        buffering: int = ...,
