...
class QName:
    text: str
    def __init__(
        self, text_or_uri: _str_argument_type, tag: Optional[_str_argument_type] = ...
    ) -> None: ...

class ElementTree:
    def __init__(
        self, element: Optional[Element] = ..., file: Optional[_file_or_filename] = ...
    ) -> None: ...
...
if sys.version_info >= (3, 8):
    ...
    def tostring(
        element: Element, encoding: Optional[str] = ..., method: Optional[str] = ...
    ) -> bytes: ...
    def tostringlist(
        element: Element, encoding: Optional[str] = ..., method: Optional[str] = ...
    ) -> List[bytes]: ...
...
class XMLParser:
    ...
    if sys.version_info >= (3, 8):
        def __init__(
            self, *, target: Optional[TreeBuilder] = ..., encoding: Optional[str] = ...
        ) -> None: ...
    else:
        def __init__(
            self,
            html: int = ...,
            target: Optional[TreeBuilder] = ...,
            encoding: Optional[str] = ...,
        ) -> None: ...
