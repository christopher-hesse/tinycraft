...
def charmap_decode(
    __data: _Decodable, __errors: _Errors = ..., __mapping: Optional[_MapT] = ...
) -> Tuple[Text, int]: ...
def charmap_encode(
    __str: _Encodable, __errors: _Errors = ..., __mapping: Optional[_MapT] = ...
) -> Tuple[bytes, int]: ...
...
if sys.platform == "win32":
    ...
    if sys.version_info >= (3, 0):
        ...
        def code_page_decode(
            codepage: int, __data: bytes, __errors: _Errors = ..., __final: int = ...
        ) -> Tuple[Text, int]: ...
        def oem_encode(str: Text, __errors: _Errors = ...) -> Tuple[bytes, int]: ...
        def code_page_encode(
            code_page: int, str: Text, __errors: _Errors = ...
        ) -> Tuple[bytes, int]: ...
