...
from concurrent.futures import Future as _ConcurrentFuture, Error
...
class Future(Awaitable[_T], Iterable[_T]):
    ...
    if sys.version_info >= (3, 7):
        ...
        def add_done_callback(
            self: _S, __fn: Callable[[_S], Any], *, context: Optional[Context] = ...
        ) -> None: ...
    else:
        @property
...
def wrap_future(
    f: Union[_ConcurrentFuture[_T], Future[_T]],
    *,
