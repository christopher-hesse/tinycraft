...
class Style:
    ...
    def lookup(
        self, style, option, state: Optional[Any] = ..., default: Optional[Any] = ...
    ): ...
    ...
    def theme_create(
        self, themename, parent: Optional[Any] = ..., settings: Optional[Any] = ...
    ): ...
...
class Entry(Widget, tkinter.Entry):
    def __init__(
        self, master: Optional[Any] = ..., widget: Optional[Any] = ..., **kw
    ): ...
    def bbox(self, index): ...
    def identify(self, x, y): ...
    def validate(self): ...
...
class Treeview(Widget, tkinter.XView, tkinter.YView):
    ...
    def tag_bind(
        self, tagname, sequence: Optional[Any] = ..., callback: Optional[Any] = ...
    ): ...
...
class OptionMenu(Menubutton):
    def __init__(
        self, master, variable, default: Optional[Any] = ..., *values, **kwargs
    ): ...
