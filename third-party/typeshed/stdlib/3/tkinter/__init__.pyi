...
class Canvas(Widget, XView, YView):
    ...
    def addtag_closest(
        self, newtag, x, y, halo: Optional[Any] = ..., start: Optional[Any] = ...
    ): ...
...
class Text(Widget, XView, YView):
    ...
    def dump(
        self, index1, index2: Optional[Any] = ..., command: Optional[Any] = ..., **kw
    ): ...
    def edit(self, *args): ...
...
class PhotoImage(Image):
    def __init__(
        self, name: Optional[Any] = ..., cnf=..., master: Optional[Any] = ..., **kw
    ): ...
    def blank(self): ...
    ...
    def write(
        self, filename, format: Optional[Any] = ..., from_coords: Optional[Any] = ...
    ): ...
    if sys.version_info >= (3, 8):
