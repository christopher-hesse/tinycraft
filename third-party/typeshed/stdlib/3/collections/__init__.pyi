...
if sys.version_info >= (3, 6):
    from typing import Collection as Collection, AsyncGenerator as AsyncGenerator
...
class UserDict(MutableMapping[_KT, _VT]):
    data: Dict[_KT, _VT]
    def __init__(
        self, dict: Optional[Mapping[_KT, _VT]] = ..., **kwargs: _VT
    ) -> None: ...
...
class UserString(Sequence[str]):
    ...
    def __getitem__(
        self: _UserStringT, i: Union[int, slice]
    ) -> _UserStringT: ...  # type: ignore
    ...
    def encode(
        self: _UserStringT, encoding: Optional[str] = ..., errors: Optional[str] = ...
    ) -> _UserStringT: ...
    def endswith(
        self, suffix: Union[str, Tuple[str, ...]], start: int = ..., end: int = ...
    ) -> bool: ...
    ...
    def startswith(
        self, prefix: Union[str, Tuple[str, ...]], start: int = ..., end: int = ...
    ) -> bool: ...
