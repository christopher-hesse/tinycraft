...
def open(
    file: _PathType, flags: int, mode: int = ..., *, dir_fd: Optional[int] = ...
) -> int: ...
...
if sys.platform != "win32":
    def chflags(
        path: _PathType, flags: int, follow_symlinks: bool = ...
...
if sys.platform != "win32":
    def mkfifo(
        path: _PathType, mode: int = ..., *, dir_fd: Optional[int] = ...
    ) -> None: ...  # Unix only

def makedirs(name: _PathType, mode: int = ..., exist_ok: bool = ...) -> None: ...
def mknod(
    path: _PathType, mode: int = ..., device: int = ..., *, dir_fd: Optional[int] = ...
) -> None: ...
...
def stat(
    path: _FdOrPathType, *, dir_fd: Optional[int] = ..., follow_symlinks: bool = ...
) -> stat_result: ...
...
if sys.platform != "win32":
    ...
    def getxattr(
        path: _FdOrPathType, attribute: _PathType, *, follow_symlinks: bool = ...
    ) -> bytes: ...  # Linux only
    def listxattr(
        path: _FdOrPathType, *, follow_symlinks: bool = ...
    ) -> List[str]: ...  # Linux only
    def removexattr(
        path: _FdOrPathType, attribute: _PathType, *, follow_symlinks: bool = ...
    ) -> None: ...  # Linux only
...
def execl(
    file: _PathType, __arg0: Union[bytes, Text], *args: Union[bytes, Text]
) -> NoReturn: ...
def execlp(
    file: _PathType, __arg0: Union[bytes, Text], *args: Union[bytes, Text]
) -> NoReturn: ...
...
_ExecVArgs = Union[
    Tuple[Union[bytes, Text], ...], List[bytes], List[Text], List[Union[bytes, Text]]
]
...
def spawnl(
    mode: int, path: _PathType, arg0: Union[bytes, Text], *args: Union[bytes, Text]
) -> int: ...
def spawnle(
    mode: int, path: _PathType, arg0: Union[bytes, Text], *args: Any
) -> int: ...  # Imprecise sig
def spawnv(mode: int, path: _PathType, args: List[Union[bytes, Text]]) -> int: ...
def spawnve(
    mode: int, path: _PathType, args: List[Union[bytes, Text]], env: _ExecEnv
) -> int: ...
...
if sys.platform == "win32":
    ...
    # Unix only
    def spawnlp(
        mode: int, file: _PathType, arg0: Union[bytes, Text], *args: Union[bytes, Text]
    ) -> int: ...
    def spawnlpe(
        mode: int, file: _PathType, arg0: Union[bytes, Text], *args: Any
    ) -> int: ...  # Imprecise signature
    def spawnvp(mode: int, file: _PathType, args: List[Union[bytes, Text]]) -> int: ...
    def spawnvpe(
        mode: int, file: _PathType, args: List[Union[bytes, Text]], env: _ExecEnv
    ) -> int: ...
