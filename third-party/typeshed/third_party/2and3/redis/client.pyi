...
class Redis(object):
    ...
    def get(
        self, name: Union[Text, bytes]
    ) -> Any: ...  # Optional[Union[str, bytes]] depending on decode_responses
    ...
    def unwatch(self): ...
    def blpop(
        self, keys: Union[_Str, Iterable[_Str]], timeout: int = ...
    ...
    def scan(
        self, cursor: int = ..., match: Optional[Text] = ..., count: Optional[int] = ...
    ) -> List[Text]: ...
    def scan_iter(
    ...
    def zrangebyscore(
        self, name, min, max, start=..., num=..., withscores=..., score_cast_func=...
    ): ...
    ...
    def zrevrangebyscore(
        self, name, max, min, start=..., num=..., withscores=..., score_cast_func=...
    ): ...
