...
class DescriptorProto(Message):
    ...
    def extension_range(
        self
    ) -> RepeatedCompositeFieldContainer[DescriptorProto.ExtensionRange]: ...
    @property
    ...
    def reserved_range(
        self
    ) -> RepeatedCompositeFieldContainer[DescriptorProto.ReservedRange]: ...
    def __init__(
        self,
        name: Optional[Text] = ...,
...
class ExtensionRangeOptions(Message):
    ...
    def uninterpreted_option(
        self
    ) -> RepeatedCompositeFieldContainer[UninterpretedOption]: ...
    def __init__(
        self, uninterpreted_option: Optional[Iterable[UninterpretedOption]] = ...
    ) -> None: ...
...
class OneofDescriptorProto(Message):
    ...
    def __init__(
        self, name: Optional[Text] = ..., options: Optional[OneofOptions] = ...
    ) -> None: ...
...
class EnumDescriptorProto(Message):
    ...
    def reserved_range(
        self
    ) -> RepeatedCompositeFieldContainer[EnumDescriptorProto.EnumReservedRange]: ...
    def __init__(
        self,
        name: Optional[Text] = ...,
...
class SourceCodeInfo(Message):
    ...
    def __init__(
        self, location: Optional[Iterable[SourceCodeInfo.Location]] = ...
    ) -> None: ...
...
class GeneratedCodeInfo(Message):
    ...
    def annotation(
        self
    ) -> RepeatedCompositeFieldContainer[GeneratedCodeInfo.Annotation]: ...
    def __init__(
        self, annotation: Optional[Iterable[GeneratedCodeInfo.Annotation]] = ...
    ) -> None: ...
