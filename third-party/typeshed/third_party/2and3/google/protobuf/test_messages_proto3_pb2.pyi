...
class TestAllTypesProto3(Message):
    ...
    class MapInt32Int32Entry(Message):
        ...
        value: int
        def __init__(
            self, key: Optional[int] = ..., value: Optional[int] = ...
        ) -> None: ...
    ...
    class MapInt32FloatEntry(Message):
        ...
        value: float
        def __init__(
            self, key: Optional[int] = ..., value: Optional[float] = ...
        ) -> None: ...
    ...
    class MapBoolBoolEntry(Message):
        ...
        value: bool
        def __init__(
            self, key: Optional[bool] = ..., value: Optional[bool] = ...
        ) -> None: ...
    class MapStringStringEntry(Message):
        key: Text
        value: Text
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[Text] = ...
        ) -> None: ...
    class MapStringBytesEntry(Message):
        key: Text
        value: bytes
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[bytes] = ...
        ) -> None: ...
    ...
    class MapStringForeignMessageEntry(Message):
        ...
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[ForeignMessage] = ...
        ) -> None: ...
    ...
    class MapStringForeignEnumEntry(Message):
        ...
        value: ForeignEnum
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[ForeignEnum] = ...
        ) -> None: ...
    optional_int32: int
    optional_int64: int
    optional_uint32: int
    ...
    def repeated_nested_message(
        self
    ) -> RepeatedCompositeFieldContainer[TestAllTypesProto3.NestedMessage]: ...
    @property
    def repeated_foreign_message(
        self
    ) -> RepeatedCompositeFieldContainer[ForeignMessage]: ...
    @property
    ...
    def map_string_nested_message(
        self
    ) -> MutableMapping[Text, TestAllTypesProto3.NestedMessage]: ...
    @property
    def map_string_foreign_message(self) -> MutableMapping[Text, ForeignMessage]: ...
    @property
    def map_string_nested_enum(
        self
    ) -> MutableMapping[Text, TestAllTypesProto3.NestedEnum]: ...
    @property
    ...
    @property
    def repeated_uint32_wrapper(
        self
    ) -> RepeatedCompositeFieldContainer[UInt32Value]: ...
    @property
    def repeated_uint64_wrapper(
        self
    ) -> RepeatedCompositeFieldContainer[UInt64Value]: ...
    @property
    def repeated_float_wrapper(self) -> RepeatedCompositeFieldContainer[FloatValue]: ...
    @property
    def repeated_double_wrapper(
        self
    ) -> RepeatedCompositeFieldContainer[DoubleValue]: ...
    @property
    def repeated_string_wrapper(
        self
    ) -> RepeatedCompositeFieldContainer[StringValue]: ...
    @property
    ...
    def __init__(
        ...
        repeated_nested_message: Optional[
            Iterable[TestAllTypesProto3.NestedMessage]
        ] = ...,
        ...
        map_string_nested_message: Optional[
            Mapping[Text, TestAllTypesProto3.NestedMessage]
        ] = ...,
        map_string_foreign_message: Optional[Mapping[Text, ForeignMessage]] = ...,
        map_string_nested_enum: Optional[
            Mapping[Text, TestAllTypesProto3.NestedEnum]
        ] = ...,
