...
class TestAllTypesProto2(Message):
    ...
    class MapStringForeignMessageEntry(Message):
        ...
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[ForeignMessageProto2] = ...
        ) -> None: ...
    ...
    class MapStringForeignEnumEntry(Message):
        ...
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[ForeignEnumProto2] = ...
        ) -> None: ...
    class Data(Message):
        group_int32: int
        group_uint32: int
        def __init__(
            self, group_int32: Optional[int] = ..., group_uint32: Optional[int] = ...
        ) -> None: ...
    ...
    def repeated_nested_message(
        self
    ) -> RepeatedCompositeFieldContainer[TestAllTypesProto2.NestedMessage]: ...
    @property
    def repeated_foreign_message(
        self
    ) -> RepeatedCompositeFieldContainer[ForeignMessageProto2]: ...
    @property
    ...
    def map_string_nested_message(
        self
    ) -> MutableMapping[Text, TestAllTypesProto2.NestedMessage]: ...
    @property
    def map_string_foreign_message(
        self
    ) -> MutableMapping[Text, ForeignMessageProto2]: ...
    @property
    def map_string_nested_enum(
        self
    ) -> MutableMapping[Text, TestAllTypesProto2.NestedEnum]: ...
    @property
    ...
    def __init__(
        ...
        repeated_nested_message: Optional[
            Iterable[TestAllTypesProto2.NestedMessage]
        ] = ...,
