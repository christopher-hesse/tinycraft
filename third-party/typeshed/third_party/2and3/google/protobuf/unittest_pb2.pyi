...
class TestAllTypes(Message):
    ...
    def repeatedgroup(
        self
    ) -> RepeatedCompositeFieldContainer[TestAllTypes.RepeatedGroup]: ...
    @property
    def repeated_nested_message(
        self
    ) -> RepeatedCompositeFieldContainer[TestAllTypes.NestedMessage]: ...
    @property
    ...
    def repeated_import_message(
        self
    ) -> RepeatedCompositeFieldContainer[ImportMessage]: ...
    @property
...
class TestForeignNested(Message):
    ...
    def __init__(
        self, foreign_nested: Optional[TestAllTypes.NestedMessage] = ...
    ) -> None: ...
...
class TestRecursiveMessage(Message):
    ...
    def __init__(
        self, a: Optional[TestRecursiveMessage] = ..., i: Optional[int] = ...
    ) -> None: ...
...
class TestIsInitialized(Message):
    class SubMessage(Message):
        ...
        def __init__(
            self, subgroup: Optional[TestIsInitialized.SubMessage.SubGroup] = ...
        ) -> None: ...
    @property
    def sub_message(self) -> TestIsInitialized.SubMessage: ...
    def __init__(
        self, sub_message: Optional[TestIsInitialized.SubMessage] = ...
    ) -> None: ...
...
class TestNestedMessageHasBits(Message):
    class NestedMessage(Message):
        ...
        def __init__(
            ...
            nestedmessage_repeated_foreignmessage: Optional[
                Iterable[ForeignMessage]
            ] = ...,
        ) -> None: ...
    @property
...
class TestFieldOrderings(Message):
    class NestedMessage(Message):
        ...
        bb: int
        def __init__(
            self, oo: Optional[int] = ..., bb: Optional[int] = ...
        ) -> None: ...
    my_string: Text
    my_int: int
    my_float: float
...
class TestOneof2(Message):
    ...
    class NestedMessage(Message):
        ...
        def __init__(
            self, qux_int: Optional[int] = ..., corge_int: Optional[Iterable[int]] = ...
        ) -> None: ...
    foo_int: int
    foo_string: Text
    foo_cord: Text
...
class TestDynamicExtensions(Message):
    ...
    def __init__(
        ...
        dynamic_message_extension: Optional[
...
class TestParsingMerge(Message):
    class RepeatedFieldsGenerator(Message):
        ...
        def __init__(
            ...
            group1: Optional[
                Iterable[TestParsingMerge.RepeatedFieldsGenerator.Group1]
            ] = ...,
            group2: Optional[
                Iterable[TestParsingMerge.RepeatedFieldsGenerator.Group2]
            ] = ...,
    ...
    class OptionalGroup(Message):
        ...
        def __init__(
            self, optional_group_all_types: Optional[TestAllTypes] = ...
        ) -> None: ...
    class RepeatedGroup(Message):
        @property
        def repeated_group_all_types(self) -> TestAllTypes: ...
        def __init__(
            self, repeated_group_all_types: Optional[TestAllTypes] = ...
        ) -> None: ...
    @property
    ...
    def repeatedgroup(
        self
    ) -> RepeatedCompositeFieldContainer[TestParsingMerge.RepeatedGroup]: ...
    def __init__(
        self,
