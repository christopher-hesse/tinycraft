...
class TestEnumMap(Message):
    class KnownMapFieldEntry(Message):
        ...
        value: Proto2MapEnum
        def __init__(
            self, key: Optional[int] = ..., value: Optional[Proto2MapEnum] = ...
        ) -> None: ...
...
class TestImportEnumMap(Message):
    class ImportEnumAmpEntry(Message):
        ...
        def __init__(
            self, key: Optional[int] = ..., value: Optional[ImportEnumForMap] = ...
        ) -> None: ...
    @property
    def import_enum_amp(self) -> MutableMapping[int, ImportEnumForMap]: ...
    def __init__(
        self, import_enum_amp: Optional[Mapping[int, ImportEnumForMap]] = ...
    ) -> None: ...
...
class TestMaps(Message):
    class MInt32Entry(Message):
        ...
        def __init__(
            self, key: Optional[int] = ..., value: Optional[TestIntIntMap] = ...
        ) -> None: ...
    ...
    class MBoolEntry(Message):
        ...
        def value(self) -> TestIntIntMap: ...
        def __init__(
            self, key: Optional[bool] = ..., value: Optional[TestIntIntMap] = ...
        ) -> None: ...
    class MStringEntry(Message):
        ...
        def value(self) -> TestIntIntMap: ...
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[TestIntIntMap] = ...
        ) -> None: ...
    @property
