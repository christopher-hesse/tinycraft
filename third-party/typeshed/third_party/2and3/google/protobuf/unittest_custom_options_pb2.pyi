...
class TestMessageWithCustomOptions(Message):
    ...
    oneof_field: int
    def __init__(
        self, field1: Optional[Text] = ..., oneof_field: Optional[int] = ...
    ) -> None: ...
...
class DummyMessageContainingEnum(Message):
    class TestEnumType(int):
        ...
        def items(
            cls
        ) -> List[Tuple[bytes, DummyMessageContainingEnum.TestEnumType]]: ...
...
class ComplexOptionType2(Message):
    ...
    def barney(
        self
    ) -> RepeatedCompositeFieldContainer[ComplexOptionType2.ComplexOptionType4]: ...
    def __init__(
        self,
