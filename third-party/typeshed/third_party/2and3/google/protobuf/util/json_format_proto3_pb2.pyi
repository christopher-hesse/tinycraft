...
class TestMessage(Message):
    ...
    def repeated_message_value(
        self
    ) -> RepeatedCompositeFieldContainer[MessageType]: ...
    def __init__(
        self,
...
class TestMap(Message):
    class BoolMapEntry(Message):
        ...
        value: int
        def __init__(
            self, key: Optional[bool] = ..., value: Optional[int] = ...
        ) -> None: ...
    ...
    class StringMapEntry(Message):
        ...
        value: int
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[int] = ...
        ) -> None: ...
    @property
...
class TestNestedMap(Message):
    ...
    class MapMapEntry(Message):
        ...
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[TestNestedMap] = ...
        ) -> None: ...
    @property
    def bool_map(self) -> MutableMapping[bool, int]: ...
    @property
...
class TestAny(Message):
    ...
    def __init__(
        self, value: Optional[Any] = ..., repeated_value: Optional[Iterable[Any]] = ...
    ) -> None: ...
