...
class TestMap(Message):
    ...
    class MapInt32BytesEntry(Message):
        ...
        value: bytes
        def __init__(
            self, key: Optional[int] = ..., value: Optional[bytes] = ...
        ) -> None: ...
    class MapInt32EnumEntry(Message):
        key: int
        value: MapEnum
        def __init__(
            self, key: Optional[int] = ..., value: Optional[MapEnum] = ...
        ) -> None: ...
    class MapInt32ForeignMessageEntry(Message):
        ...
        def __init__(
            self, key: Optional[int] = ..., value: Optional[ForeignMessage1] = ...
        ) -> None: ...
    class MapStringForeignMessageEntry(Message):
        ...
        def value(self) -> ForeignMessage1: ...
        def __init__(
            self, key: Optional[Text] = ..., value: Optional[ForeignMessage1] = ...
        ) -> None: ...
    class MapInt32AllTypesEntry(Message):
        ...
        def __init__(
            self, key: Optional[int] = ..., value: Optional[TestAllTypes] = ...
        ) -> None: ...
    @property
...
class TestMessageMap(Message):
    ...
    def __init__(
        self, map_int32_message: Optional[Mapping[int, TestAllTypes]] = ...
    ) -> None: ...
...
class TestRequiredMessageMap(Message):
    class MapFieldEntry(Message):
        ...
        def __init__(
            self, key: Optional[int] = ..., value: Optional[TestRequired] = ...
        ) -> None: ...
    @property
    def map_field(self) -> MutableMapping[int, TestRequired]: ...
    def __init__(
        self, map_field: Optional[Mapping[int, TestRequired]] = ...
    ) -> None: ...
...
class TestArenaMap(Message):
    ...
    class MapInt32ForeignMessageNoArenaEntry(Message):
        ...
        def __init__(
            self, key: Optional[int] = ..., value: Optional[ForeignMessage] = ...
        ) -> None: ...
    @property
    def map_int32_int32(self) -> MutableMapping[int, int]: ...
    @property
    ...
    def map_int32_foreign_message_no_arena(
        self
    ) -> MutableMapping[int, ForeignMessage]: ...
    def __init__(
        self,
        map_int32_int32: Optional[Mapping[int, int]] = ...,
        map_int64_int64: Optional[Mapping[int, int]] = ...,
        ...
        map_int32_enum: Optional[Mapping[int, MapEnum]] = ...,
        map_int32_foreign_message: Optional[Mapping[int, ForeignMessage1]] = ...,
        map_int32_foreign_message_no_arena: Optional[
            Mapping[int, ForeignMessage]
        ] = ...,
    ) -> None: ...
...
class MessageContainingEnumCalledType(Message):
    ...
    def __init__(
        self, type: Optional[Mapping[Text, MessageContainingEnumCalledType]] = ...
    ) -> None: ...
...
class TestRecursiveMapMessage(Message):
    ...
    def __init__(
        self, a: Optional[Mapping[Text, TestRecursiveMapMessage]] = ...
    ) -> None: ...
