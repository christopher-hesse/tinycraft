...
class HTTPException(Exception):
    ...
    def __init__(
        self, description: Optional[Text] = ..., response: Optional[Response] = ...
    ) -> None: ...
    @classmethod
    ...
    def get_response(
        self, environ: Optional[Union[WSGIEnvironment, _EnvironContainer]] = ...
    ) -> Response: ...
    def __call__(
...
class MethodNotAllowed(HTTPException):
    ...
    valid_methods: Any
    def __init__(
        self, valid_methods: Optional[Any] = ..., description: Optional[Any] = ...
    ): ...
