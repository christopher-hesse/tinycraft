...
class Environment:
    ...
    def call_test(
        self, name, value, args: Optional[Any] = ..., kwargs: Optional[Any] = ...
    ): ...
    def parse(
    ...
    def preprocess(
        self, source: Text, name: Optional[Any] = ..., filename: Optional[Any] = ...
    ): ...
    def compile(
        self,
        source,
    ...
    def select_template(
        self,
        names: List[Union[Template, Text]],
        parent: Optional[Text] = ...,
    ...
    def get_or_select_template(
        ...
        template_name_or_list: Union[
            Union[Template, Text], List[Union[Template, Text]]
        ],
        parent: Optional[Text] = ...,
        globals: Optional[Dict[str, Any]] = ...,
    ) -> Template: ...
