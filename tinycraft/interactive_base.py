...
class Interactive(abc.ABC):
    ...
    def _draw(self):
        ...
        gl.glBindTexture(gl.GL_TEXTURE_2D, self._texture_id)
        buf = self._image.tobytes()
        video_buffer = ctypes.cast(buf, ctypes.POINTER(ctypes.c_short))
        gl.glTexSubImage2D(
            gl.GL_TEXTURE_2D,
            0,
            0,
    ...
    def _restart_recording(self):
        ...
        assert isinstance(self._record_dir, str)
